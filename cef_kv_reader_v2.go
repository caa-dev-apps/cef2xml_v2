...
//x func EachLine(i_path string) chan string {
//x 	output := make(chan string, 16)
//x 
//x 	go func() {
...
//x func eachKeyVal(lines chan string) chan KeyVal {
...
//x 		for l_line := range lines {
//x         Line{tag &i_path, ln: ln++, line: &line }    
