...
func (hds *CefHeaderData) kv_meta_entry(kv *KeyVal)  (err error){
    ...
    switch hds.m_meta {
        ...
        case EXPERIMENT:                        err = hds.v_append(&hds.m_data.EXPERIMENTS.EXPERIMENT, kv)
        ...
        case DATASET_TYPE:                      err = hds.v_set(&hds.m_data.DATASETS.DATASET_TYPE, kv)       //smcc 200202
        case DATASET_TIME_SPAN:                  err = hds.v_set(&hds.m_data.DATASETS.DATASET_TIME_SPAN, kv)   //smcc 2002002
        ...
        case FILE_NAME:                         err = hds.v_set(&hds.m_data.DATASETS.FILE.FILE_NAME, kv)
